...
public class TestData {
    ...
    public Comment newComment = new Comment(1L, "comment1", item2, user1, Instant.parse("2025-03-09T00:00:01+00:00"));
    public Comment comment1 = new Comment(2L, "comment2", item1, user2, Instant.parse("2025-03-10T00:00:01+00:00"));
    public Comment comment2 = new Comment(3L, "comment3", item2, user2, Instant.parse("2025-03-11T00:00:01+00:00"));
    public Comment comment3 = new Comment(4L, "comment4", item2, user1, Instant.parse("2025-03-12T00:00:01+00:00"));
    ...
    public ItemRequest newRequest = new ItemRequest(1L, "Request description 1", Instant.parse("2025-03-01T18:22:23+00:00"), user1);
    public ItemRequest request1 = new ItemRequest(2L, "Request description 2", Instant.parse("2025-03-01T18:22:23+00:00"), user2);
    public ItemRequest request2 = new ItemRequest(3L, "Request description 3", Instant.parse("2025-03-03T00:00:00+00:00"), user3);
    public ItemRequest request3 = new ItemRequest(4L, "Request description 4", Instant.parse("2025-03-04T00:00:00+00:00"), user1);
